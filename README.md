...
Uses Civic as the centralized database for storing and managing application data.

Backend services run on a configured IP address for remote access and collaboration.
